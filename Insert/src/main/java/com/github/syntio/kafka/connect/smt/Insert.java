...
public abstract class Insert<R extends ConnectRecord<R>> implements Transformation<R> {
    ...
    public static class Key<R extends ConnectRecord<R>> extends Insert<R> {
    ...
    public static class Value<R extends ConnectRecord<R>> extends Insert<R> {
